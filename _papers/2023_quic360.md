...
description: A novel image captioning approach that leverages queries and multi-context
  360-degree imagery.
date: 2023-12-06
type: international
firstpage: 6940
lastpage: 6954
pdf: https://aclanthology.org/2023.findings-emnlp.463.pdf
code_link: https://github.com/Silviase/QuIC-360
bibtex: "@inproceedings{maeda2023quic360,\n  title = {Query-based Image Captioning\
  \ from Multi-context 360-degree Images},\n  author = {Koki Maeda and Shuhei Kurita\
  \ and Taiki Miyanishi and Naoaki Okazaki},\n  booktitle = {Findings of the Association\
